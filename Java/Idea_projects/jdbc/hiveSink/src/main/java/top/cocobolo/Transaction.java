...
public class Transaction {
    ...
    public static Transaction getRandomTransaction(){
        Integer transaction_id = (int)(100000000+Math.random()*(1000000000-100000000+1));
        Integer card_number = (int)(10000000+Math.random()*(100000000-10000000+1));
        Integer terminal_id = (int)(1000000+Math.random()*(10000000-1000000+1));
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 100; i++) {
            System.out.println(100000000+(int)(Math.random()*(1000000000+1-100000000)));
        }
    }
}
